...
- **Sofa presets:** 17 RH sectional models (UPH bounds measured in the UE project), plus user presets in `localStorage`. The default preset label is the render prefix `KOPER_LEFT_ARM_L_SECTIONAL_prod39250480` so it can load server renders immediately.
